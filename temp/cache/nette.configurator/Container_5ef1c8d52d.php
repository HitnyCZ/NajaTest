<?php
// source: C:\inetpub\wwwroot\SlimShop\AjaxTest/config/common.neon
// source: C:\inetpub\wwwroot\SlimShop\AjaxTest/config/local.neon
// source: array
...
class Container_5ef1c8d52d extends Nette\DI\Container
{
	protected $tags = [
		'nette.inject' => [
			'application.1' => true,
	...
	public function __construct(array $params = [])
	{
		...
		$this->parameters += [
			'appDir' => 'C:\inetpub\wwwroot\SlimShop\AjaxTest\app',
			'wwwDir' => 'C:\inetpub\wwwroot\SlimShop\AjaxTest\www',
			'vendorDir' => 'C:\inetpub\wwwroot\SlimShop\AjaxTest\vendor',
			'debugMode' => true,
			'productionMode' => false,
			'consoleMode' => false,
			'tempDir' => 'C:\inetpub\wwwroot\SlimShop\AjaxTest/temp',
		];
	}
	...
	public function createServiceApplication__presenterFactory(): Nette\Application\IPresenterFactory
	{
		$service = new Nette\Application\PresenterFactory(new Nette\Bridges\ApplicationDI\PresenterFactoryCallback(
			$this,
			5,
			'C:\inetpub\wwwroot\SlimShop\AjaxTest/temp/cache/nette.application/touch'
		));
	...
	{
		return new Nette\Caching\Storages\SQLiteJournal('C:\inetpub\wwwroot\SlimShop\AjaxTest/temp/cache/journal.s3db');
	}
	...
	public function createServiceCache__storage(): Nette\Caching\Storage
	{
		return new Nette\Caching\Storages\FileStorage(
			'C:\inetpub\wwwroot\SlimShop\AjaxTest/temp/cache',
			$this->getService('cache.journal')
		);
	}


	public function createServiceContainer(): Container_5ef1c8d52d
	{
		return $this;
	}
	...
	public function createServiceLatte__latteFactory(): Nette\Bridges\ApplicationLatte\LatteFactory
	{
		return new class ($this) implements Nette\Bridges\ApplicationLatte\LatteFactory {
			...
			public function __construct(Container_5ef1c8d52d $container)
			{
			...
			public function create(): Latte\Engine
			{
				...
				$service->setTempDirectory('C:\inetpub\wwwroot\SlimShop\AjaxTest/temp/cache/latte');
